    ...
    return (
        <div>
            ...
            <div className="px-12 py-8 border-b border-gray-200">
                <h1 className="font-bebas text-black text-5xl tracking-wide">YOUR WISHLIST</h1>
                    ...
                    <div className="grid grid-cols-4 gap-6">
                        {wishlist.map((item) => (
                            <div key={item.id} className="group">
                                {/* Image */}
                                <div
                                    className="bg-gray-100 h-80 relative overflow-hidden cursor-pointer"
                                ...
                                <div className="mt-3 cursor-pointer" onClick={() => navigate(`/products/${item.productId}`)}>
                                    ...
                                    <p className="font-sans text-black font-semibold text-sm mt-1">₹{item.price?.toLocaleString()}</p>
                                </div>
            ...
            <div className="bg-[#007CC6] w-full flex items-center justify-center px-20 py-16 mt-8">
                <div className="text-center">
                    <h2 className="font-bebas text-white text-6xl tracking-widest">YOUR FAVOURITES.<br/>ALL IN ONE PLACE.</h2>

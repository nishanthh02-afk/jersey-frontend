    ...
    return (
        <div>
            ...
            <div className="px-20 py-16 border-b border-gray-200">
                ...
                <h1 className="font-bebas text-black text-6xl tracking-wider">CAREERS AT REALWEAR</h1>
            ...
            <div className="px-20 py-16 max-w-4xl">
                ...
                <div className="space-y-4">
                    {openings.map((job, index) => (
                        <div key={index} className="border border-gray-200 p-6 flex justify-between items-center hover:border-black transition-all">
                            <div>
                            ...
                            <a href="mailto:careers@realwear.com" className="ml-8 flex-shrink-0 border border-black px-6 py-2 font-sans text-sm font-medium hover:bg-black hover:text-white transition-all">
                                APPLY
                            </a>
                        </div>
                    ))}

    ...
    return (
        <div>
            ...
            <div className="px-20 py-16 border-b border-gray-200">
                ...
                <h1 className="font-bebas text-black text-6xl tracking-wider">CONTACT US</h1>
                        ...
                        <div className="space-y-4">
                            <div className="flex gap-4">
                                <div className="w-1/2">
                                    ...
                                    <input
                                        ...
                                        className="w-full border border-gray-300 px-4 py-3 font-sans text-sm outline-none focus:border-black"
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={6}
                                    className="w-full border border-gray-300 px-4 py-3 font-sans text-sm outline-none focus:border-black resize-none"
                                    placeholder="Tell us how we can help..."
                                />
                            </div>
                            <button
                                onClick={handleSubmit}
                                className="bg-black text-white font-sans font-medium tracking-widest text-sm px-8 py-4 hover:bg-gray-800 w-full"
                            >
                                SEND MESSAGE
                            </button>
                        </div>

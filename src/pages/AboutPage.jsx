...
function AboutPage() {
    ...
    return (
        <div>
            ...
            <div className="bg-black w-full px-6 md:px-20 py-16 md:py-24">
                <div className="max-w-4xl mx-auto text-center">
                    <p className="font-sans text-gray-400 text-sm tracking-widest mb-4">OUR STORY</p>
                    <h1 className="font-bebas text-white text-5xl md:text-7xl tracking-wider leading-none">BORN FROM<br/>THE BEAUTIFUL GAME</h1>
                </div>
            </div>

            <div className="px-6 md:px-20 py-12 md:py-16 max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-3 gap-4 md:gap-8 mt-12 md:mt-16">
                    {[
                        ...
                        <div key={index} className="text-center border border-gray-200 py-8 md:py-10">
                            <p className="font-bebas text-black text-3xl md:text-5xl tracking-wider">{stat.number}</p>
                            <p className="font-sans text-gray-500 text-xs md:text-sm mt-2">{stat.label}</p>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="bg-[#007CC6] w-full flex items-center justify-center px-6 md:px-20 py-16">
                <div className="text-center">
                    <h2 className="font-bebas text-white text-4xl md:text-6xl tracking-widest">WEAR WHAT THE LEGENDS WEAR.</h2>

...
function ForgotPasswordPage() {
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row">
            {/* Left side */}
            <div className="w-full md:w-1/2 bg-black flex flex-col items-center justify-center p-10 md:p-16 py-16">
                ...
                <div className="mt-10 md:mt-16 text-center">
                    <h2 className="font-bebas text-white text-4xl md:text-5xl tracking-wider leading-tight">
            ...
            {/* Right side */}
            <div className="w-full md:w-1/2 bg-white px-8 md:px-16 py-12 flex flex-col justify-center">
                ...
                <p className="font-sans text-gray-500 text-sm mt-2">
                    {step === 1 ? 'Enter your registered email address' : `OTP sent to ${email}`}
                </p>

                {success && <p className="text-[#408267] text-sm mt-4 font-sans">{success}</p>}
                ...
                {step === 1 ? (
                    ...
                    <>
                        ...
                        <input type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)}
                               maxLength={8} placeholder="NEW PASSWORD *"
                        ...
                        <p onClick={() => { setStep(1); setError(''); setSuccess('') }}
                ...
                <p className="font-sans text-black text-sm mt-8">
                    ...
                    <span onClick={() => navigate('/login')} className="underline cursor-pointer font-medium hover:text-gray-500">Log in</span>
                </p>
            </div>
        </div>
    )

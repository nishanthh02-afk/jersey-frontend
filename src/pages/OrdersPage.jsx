    ...
    return (
        <div>
            ...
            <div className="px-12 py-8 border-b border-gray-200">
                ...
                <h1 className="font-bebas text-black text-5xl tracking-wide mt-1">MY ORDERS</h1>
            ...
            {loading ? (
                ...
                <div className="px-12 py-10 space-y-6 min-h-screen">
                    {orders.map((order) => (
            ...
            <div className="bg-[#007CC6] w-full flex items-center justify-center px-20 py-16">
                <div className="text-center">
                    <h2 className="font-bebas text-white text-6xl tracking-widest">TRACK YOUR KITS.<br/>STAY IN THE GAME.</h2>

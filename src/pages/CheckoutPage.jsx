    ...
    return (
        <div>
            ...
            <div className="px-12 py-8 border-b border-gray-200">
                ...
                <h1 className="font-bebas text-black text-5xl tracking-wide mt-1">CHECKOUT</h1>
            </div>

            <div className="px-12 py-10 flex gap-16 min-h-screen">
            ...
            <div className="bg-[#007CC6] w-full flex items-center justify-center px-20 py-16">
                <div className="text-center">
                    <h2 className="font-bebas text-white text-6xl tracking-widest">SECURE CHECKOUT.<br/>FAST DELIVERY.</h2>

    ...
    return (
        <div>
            ...
            <div className="px-20 py-16 border-b border-gray-200">
                ...
                <h1 className="font-bebas text-black text-6xl tracking-wider">COOKIE SETTINGS</h1>
                <p className="font-sans text-gray-500 text-base mt-2">Manage how we use cookies on your device.</p>
            </div>

            <div className="px-20 py-16 max-w-3xl">
                <p className="font-sans text-gray-500 text-sm leading-relaxed mb-12">We use cookies to improve your experience on Realwear. Some cookies are necessary for the site to function, while others help us understand how you use the site. You can manage your preferences below.</p>

                <div className="space-y-6">
                    {[
                        { key: 'necessary', label: 'NECESSARY COOKIES', desc: 'Required for the website to function. Cannot be disabled. These include session cookies, authentication tokens, and cart data.', locked: true },
                        { key: 'analytics', label: 'ANALYTICS COOKIES', desc: 'Help us understand how visitors interact with our website. Data is anonymised and used to improve our services.', locked: false },
                        { key: 'marketing', label: 'MARKETING COOKIES', desc: 'Used to show you relevant ads and promotions based on your browsing activity. You can opt out at any time.', locked: false },
                    ].map((cookie) => (
                        <div key={cookie.key} className="border border-gray-200 p-6 flex justify-between items-start">
                            ...
                            <div className="ml-8 flex-shrink-0">
                                {cookie.locked ? (
                                    ...
                                    <button
                                        onClick={() => setPreferences(prev => ({ ...prev, [cookie.key]: !prev[cookie.key] }))}

                ...
                <div className="grid grid-cols-2 md:flex md:justify-around gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="text-white text-sm hover:underline cursor-pointer font-sans">Sale</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="text-white text-sm hover:underline cursor-pointer font-sans">Serie A</li>
                            <li className="text-white text-sm hover:underline cursor-pointer font-sans">Bundesliga</li>
                            <li className="text-white text-sm hover:underline cursor-pointer font-sans">Champions League</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="text-white text-sm hover:underline cursor-pointer font-sans">Contact Us</li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="text-white text-sm hover:underline cursor-pointer font-sans">Privacy Policy</li>
                            <li className="text-white text-sm hover:underline cursor-pointer font-sans">Terms & Conditions</li>
                        </ul>
                    </div>

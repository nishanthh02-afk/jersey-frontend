    ...
    return (
        <div>
            ...
            <div className="px-12 py-8 border-b border-gray-200">
                <h1 className="font-bebas text-black text-5xl tracking-wide">MY ACCOUNT</h1>
            </div>

            <div className="px-12 py-10 flex gap-12 min-h-screen">
                    ...
                    <div className="border border-gray-200 p-6">
                        ...
                        <div className="mt-8 space-y-1">
                            <div
                                ...
                                className="flex items-center gap-3 px-3 py-2.5 cursor-pointer hover:bg-gray-50 rounded"
                            >
                            ...
                            <div
                                ...
                                className="flex items-center gap-3 px-3 py-2.5 cursor-pointer hover:bg-red-50 rounded mt-4"
                            >
                ...
                <div className="flex-1">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div
                            onClick={() => navigate('/orders')}
                            className="border border-gray-200 p-6 cursor-pointer hover:border-black transition-all"
                        >
            ...
            <div className="bg-[#007CC6] w-full flex items-center justify-center px-20 py-16">
                <div className="text-center">
                    <h2 className="font-bebas text-white text-6xl tracking-widest">YOUR ACCOUNT.<br/>YOUR GAME.</h2>
